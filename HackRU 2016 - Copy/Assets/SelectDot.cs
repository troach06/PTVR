...
public class SelectDot : MonoBehaviour
    ...
    void OnTriggerEnter(Collider other)
        ...
        else if ((other.gameObject.tag == "1") && (line1.enabled == true || line2.enabled == true))
            {
            line1.enabled = false;
            line2.enabled = false;
        ...
        else if ((other.gameObject.tag == "2") && (line2.enabled == false && line3.enabled == false))
            {
        ...
        else if ((other.gameObject.tag == "2") && (line2.enabled == true || line3.enabled == true ))
            {
            line1.enabled = false;
            line2.enabled = false;
            line3.enabled = false;
        ...
        else if ((other.gameObject.tag == "3") && (line3.enabled == true || line == lineobject1.GetComponent<LineRenderer>()))
            {
            line3.enabled = false;
            line2.enabled = false;
            line1.enabled = false;
